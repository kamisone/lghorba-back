...
import { ProductOptionValueImage } from './commerce/entities/product-option-value-image.entity';
...
import { MediaFolder } from './media/media-folder.entity';
