...
const TranslateShortTextSchema = z.object({
  text: z.string().min(1).max(2000),
});
const TranslateHtmlSchema = z.object({ html: z.string().min(1) });
const TranslateInfoSectionSchema = z.object({
  label: z.string().min(1).max(200),
  value: z.string().min(1).max(5000),
});
const TranslateFaqSchema = z.object({
  question: z.string().min(1).max(300),
  answer: z.string().min(1).max(5000),
});
const TranslateStoryItemSchema = z.object({
  title: z.string().min(1).max(300),
  description: z.string().min(1).max(5000),
});
const TranslateTrustBadgeSchema = z.object({
  title: z.string().min(1).max(200),
  subtitle: z.string().max(300),
});
const TranslateSocialVideoSchema = z.object({
...
export class ProductAdminController {
  ...
  create(
    ...
    dto: z.infer<typeof CreateProductSchema>,
  ) {
  ...
  // writes the section in English, then clicks "Generate" to get French
  // (the shop's base language) plus the other overlay languages back.

  @Post('sections/title/translate')
  @HttpCode(200)
  translateTitleSection(
  ...
  @HttpCode(200)
  translateShortDescriptionSection(
    @Body(new ZodValidationPipe(TranslateShortTextSchema))
    dto: z.infer<typeof TranslateShortTextSchema>,
  ) {
  ...
  @HttpCode(200)
  translateInfoSectionsSection(
    @Body(new ZodValidationPipe(TranslateInfoSectionSchema))
    dto: z.infer<typeof TranslateInfoSectionSchema>,
  ) {
  ...
  @HttpCode(200)
  translateFaqsSection(
    @Body(new ZodValidationPipe(TranslateFaqSchema))
    dto: z.infer<typeof TranslateFaqSchema>,
  ) {
  ...
  @HttpCode(200)
  translateStoryItemsSection(
    @Body(new ZodValidationPipe(TranslateStoryItemSchema))
    dto: z.infer<typeof TranslateStoryItemSchema>,
  ) {
  ...
  @HttpCode(200)
  translateTrustBadgeSection(
    @Body(new ZodValidationPipe(TranslateTrustBadgeSchema))
    dto: z.infer<typeof TranslateTrustBadgeSchema>,
  ) {
  ...
  @HttpCode(200)
  translateSocialVideoSection(
    @Body(new ZodValidationPipe(TranslateSocialVideoSchema))
    dto: z.infer<typeof TranslateSocialVideoSchema>,
  ) {
  ...
  @HttpCode(200)
  translateStoryNarrativeTitleSection(
    @Body(new ZodValidationPipe(TranslateTextSchema))
    dto: z.infer<typeof TranslateTextSchema>,
  ) {
  ...
  @HttpCode(200)
  translateSocialVideosTitleSection(
    @Body(new ZodValidationPipe(TranslateTextSchema))
    dto: z.infer<typeof TranslateTextSchema>,
  ) {
  ...
  addVariant(
    ...
    dto: z.infer<typeof CreateVariantSchema>,
  ) {
  ...
  updateVariant(
    ...
    @Body(new ZodValidationPipe(UpdateVariantSchema))
    dto: z.infer<typeof UpdateVariantSchema>,
  ) {
  ...
  addAttribute(
    ...
    return this.products.addProductAttribute(
      productId,
      dto.attributeId,
      dto.defaultOptionValueId,
      dto.sortOrder,
    );
  }
  ...
  updateAttribute(
    ...
    return this.products.updateProductAttribute(
      productId,
      attributeId,
      dto.defaultOptionValueId,
    );
  ...
  setOptionImage(
    ...
    return this.products.setProductOptionImage(
      productId,
      optionValueId,
      dto.mediaKey,
    );
