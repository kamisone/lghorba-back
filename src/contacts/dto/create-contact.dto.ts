...
export const CreateContactSchema = z.object({
  ...
  _hp:    z.string().max(500).optional(),     // honeypot value
  _t:     z.number().int().positive().optional(), // form rendered-at timestamp (epoch ms)
  _token: z.string().max(2500).optional(),    // Cloudflare Turnstile token
});
