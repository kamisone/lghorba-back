...
export class AddPausedStatus1776972079355 implements MigrationInterface {
    name = 'AddPausedStatus1776972079355'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."rent_sessions_status_enum_old" AS ENUM('active', 'pending_stop', 'ended')`);
        await queryRunner.query(`ALTER TABLE "rent_sessions" ALTER COLUMN "status" DROP DEFAULT`);
