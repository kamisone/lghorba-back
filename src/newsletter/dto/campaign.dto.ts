import { z } from 'zod';
import { AudienceDefinition, CampaignType } from '../newsletter-campaign.entity';

export const AudienceSchema = z.object({
  segment: z.enum(['all', 'fr', 'en', 'customers', 'non_customers', 'purchasers', 'newsletter_only', 'tags']),
  tags: z.array(z.string().max(50)).optional(),
}).transform((v) => v as AudienceDefinition);
